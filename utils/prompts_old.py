...
- Linear (LIN): $k(x,y) = \sum_{i=1}^{\\text{input_dim}} \sigma^2_i x_iy_i$ --> parameter: $\sigma^2$ (sigma)
...
So For example,
```
next kernels: [""CP(LIN{slope: NUM},SE{variance: NUM, lengthscale: NUM}, x: NUM)" , "CP(LIN{slope: NUM},PER{period: NUM, variance: NUM, lengthscale: NUM}, x: NUM)" ,... ...]
```
